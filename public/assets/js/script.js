...
(function($) {
	...
	$('.indexfive .owl-carousel.services-list').owlCarousel({
		...
		margin:15,
		nav:true,
		navText : ["<i className='fa fa-caret-left'></i>","<i className='fa fa-caret-right'></i>"],
		navContainer: '.mynav',
		responsive:{
			0:{
				items:1
	...
	if($('.indexseven #customers-testimonials').length > 0) {
		$('.indexseven #customers-testimonials').owlCarousel({
			...
			navText: ["<i className='fas fa-arrow-left owl-nav-left'></i>", "<i className='fas fa-arrow-right owl-nav-right ms-3'></i>"],
		});
	}
	...
	$('.indexfourteen .owl-carousel.university').owlCarousel({
		...
		margin:15,
		nav:true,
		navText: ['<span className="fas fa-chevron-left"></span>','<span className="fas fa-chevron-right"></span>'],
		navContainer: '.slide-nav-1',
		responsive:{
			0:{
				items:1
