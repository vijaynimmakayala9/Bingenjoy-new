...
'<div className="profile-widget" style="width: 100%; display: inline-block;">'+
	'<div className="pro-img">'+
		'<a href="' + marker.profile_link + '" tabindex="0" target="_blank">'+
			'<img className="img-fluid" alt="' + marker.doc_name + '" src="' + marker.image + '">'+
		'</a>'+
	'</div>'+
	'<div className="pro-content">'+
		...
		'</h3>'+
		'<p className="speciality">' + marker.speciality + '</p>'+
		'<div className="rating">'+
			...
			'<span className="d-inline-block average-rating"> (' + marker.total_review + ')</span>'+
		'</div>'+
		'<ul className="available-info">'+
			'<li><i className="fas fa-map-marker-alt"></i> ' + marker.address + ' </li>'+
			'<li><i className="far fa-clock"></i> ' + marker.next_available + '</li>'+
			'<li><i className="far fa-money-bill-alt"></i> ' + marker.amount + '</li>'+
		'</ul>'+
	'</div>'+
'</div>';
