          ...
          >
            ...
            <div className="main-menu-wrapper">
              ...
              <ul className="main-nav" >
                ...
                <li>
                  <NavLink to="/locations" style={{ color: currentPage() === "locations" ? "#800080" : "", }}>THEATRE'S</NavLink>
                </li>
                <li>
        ...
        <div className="cp-floating-area d-block zi-1100 p-relative">
          <div className="cp-floating-action cp-bg-move-y">
            ...
            <a
              ...
              tooltip="Call Now"
              onClick={() => console.log("Calling: 8977917555")}
            >
            ...
            <a
              ...
              tooltip="WhatsApp"
              onClick={() =>
                console.log("Redirecting to WhatsApp number: 8977917555")
              }
            >
