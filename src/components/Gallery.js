...
function Gallery() {
  ...
  return (
    ...
    <Helmet>
        <meta charSet="utf-8" />
        <title>
        Private Theater for Birthdays & Anniversaries | BingeNJoy
        </title>
        <meta
          name="description"
          content="Looking for a unique celebration venue in Hyderabad? BingeNJoy offers luxury private theaters with Lavish decor & food options for any special occasion."
        />
      </Helmet>
        ...
        <>
          <div className="home-page indexsix">
            ...
            <main className="main-wrapper">
              ...
              <section
                className="shop-area pt-2 pb-2 p-relative wow fadeInUp animated lightest-back"
