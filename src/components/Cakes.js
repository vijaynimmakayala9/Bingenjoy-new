...
function Cakes() {
  ...
  const { couponCode } = useCoupon(); // Access coupon code from context

 // Get the coupon code from location state
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>
          Birthday celebration places in Hyderabad | BingeNJoy
        </title>
        <meta
          name="description"
          content="Looking for birthday celebration places in Hyderabad? BingeNJoy offers private theatres with Lavish decor, custom cakes, food, and a memorable experience."
        />
      </Helmet>
